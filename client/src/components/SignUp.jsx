...
const SignUp = () => {
    return (
        <form className="w-[400px] rounded-[14px]  p-5 bg-white shadow-signup">
            ...
            <button type="submit" className="text-white mx-2 hover:from-[#ab293f] hover:to-[#ab293f] bg-gradient-to-r from-[#26d0ce] to-[#1a2980] font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center">Proceed</button>
        </form>
