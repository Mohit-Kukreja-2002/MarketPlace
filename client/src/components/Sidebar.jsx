...
const Sidebar = () => {
    ...
    return (
        <div className='bg-white'>
                            ...
                            <div className="relative flex-col items-center ms-3">
                                <div>
                                    <button onClick={() => setIsUserMenuOpen(prevState => !prevState)}
                                        ...
                                        <img className="w-8 h-8 rounded-full" src={user.avatar?.url || "https://flowbite.com/docs/images/people/profile-picture-5.jpg"} alt="user photo" />
                                    </button>
                                </div>
                                <div className={`z-50 ${isUserMenuOpen ? 'user-menu-open absolute right-2 top-10' : 'user-menu-closed'} text-base list-none bg-white divide-y divide-gray-100 rounded shadow`} id="dropdown-user">
                                    ...
                                    <div className="px-4 py-3" role="none">
                                        ...
                                        <p className="text-sm font-medium text-gray-900 truncate max-w-52 text-wrap" role="none">
            ...
            <aside id="logo-sidebar" className={`fixed top-0 left-0 z-40 w-64 sm:w-48 900px:w-64 h-screen pt-20 transition-transform ${isSidebarOpen ? 'sidebar-open' : 'sidebar-closed'} bg-white border-r border-gray-200 sm:translate-x-0`}>
                ...
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white ">
                    <ul className="space-y-2 font-medium">
                        <li onClick={() => setActive(1)}>
                            <a href="#" className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 ${active === 1 ? "bg-gray-100" : ""} group`}>
                        ...
                        {/* <li>
                            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                                ...
                                <span className="inline-flex items-center justify-center w-3 h-3 p-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full ms-3 ">3</span>
                            </a>
                        </li> */}
                        <li onClick={() => setActive(2)}>
                            <a href="#" className={`flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 ${active === 2 ? "bg-gray-100" : ""} group`}>
            ...
            <div className="p-4 sm:ml-48 900px:ml-64">
                <div className="p-4 rounded-lg sm:border-2 sm:border-gray-200 sm:border-dashed">
