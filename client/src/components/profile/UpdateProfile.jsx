...
const UpdateProfile = () => {
    ...
    return (
        <div className={`flex flex-col `} >
            <div role="alert" className={`flex justify-center alert alert-error ${user.profileCompleted === true ? "hidden" : ""}`}>
            ...
            <div className='flex flex-col items-center justify-center max-w-4xl mx-auto mt-5 bg-white 400px:p-6 900px:flex-row 900px:items-start'>
